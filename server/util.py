...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier('C:\code\SportsPersonClassifier\model\haarcascades\haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('C:\code\SportsPersonClassifier\model\haarcascades\haarcascade_eye.xml')
...
if __name__ == '__main__':
    ...
    print(classify_image(None, "./test_images/neeraj2.jpg"))